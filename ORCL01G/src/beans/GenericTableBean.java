...
public class GenericTableBean {
	...
	private List<Tabellen> table;
	private String className;
	private Tabellen selectedRow;
    ...
    public void init() {
		...
		try {
			setTable(dao.findAll2(tableToClass.get(className)));
			populateColumns();
	...
	public List<Tabellen> getTable() {
		return table;
	}
	public void setTable(List<Tabellen> table) {
		this.table = table;
	}
	...
	public Tabellen getSelectedRow() {
		return selectedRow;
	}
	public void setSelectedRow(Tabellen selectedRow) {
		System.out.println("setSelectedRow: " + selectedRow.toString());
		this.selectedRow = (Tabellen)selectedRow;
	}
	public void onRowSelect(SelectEvent event) {
		Tabellen selected = (Tabellen) event.getObject();
